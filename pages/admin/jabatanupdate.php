...
if (isset($_GET['id'])){
    ...
    if(isset($_POST['button_update'])){
        $stmt = $db->prepare("UPDATE jabatan SET nama_jabatan = ?, gapok_jabatan = ?, tunjangan_jabatan = ?, uang_makan_perhari = ? WHERE id = ?");
    ...
    $stmt = $db->prepare("SELECT * FROM jabatan WHERE id = ?");
